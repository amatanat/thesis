...
# find a view by id
com_viber_voip___id_fab_compose = vc.findViewByIdOrRaise("com.viber.voip:id/fab_compose")
if com_viber_voip___id_fab_compose:

	# click the view
	com_viber_voip___id_fab_compose.touch()
	vc.dump(window='0')

	# find a Contact by its text
	com_viber_voip___id_name = vc.findViewWithTextOrRaise(u'Tomi')
	if com_viber_voip___id_name:
		com_viber_voip___id_name.touch()
